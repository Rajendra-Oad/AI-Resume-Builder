...
public class AiController {
    ...
    public AiController(AiService aiService, AiJobService aiJobService, CurrentUser currentUser) {
        this.aiService = aiService; this.aiJobService = aiJobService; this.currentUser=currentUser;
    }
    @org.springframework.web.bind.annotation.GetMapping("/usage") public ResponseEntity<ApiResponse<AiUsageResponse>> usage(){return ResponseEntity.ok(ApiResponse.success(aiService.usage(currentUser.email()),"AI usage retrieved."));}
