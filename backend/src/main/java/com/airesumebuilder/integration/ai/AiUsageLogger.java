...
public class AiUsageLogger {
    private final AiUsageRepository usage; private final AiCostCalculator costs;
    public AiUsageLogger(AiUsageRepository usage, AiCostCalculator costs) { this.usage = usage; this.costs=costs; }
    @Transactional
